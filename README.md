...
| 多服务商 BYOK | 内置 OpenAI、Anthropic、Kimi、硅基流动中国站 / 国际站、OpenRouter、Gemini 与 xAI 等预设，也支持自定义兼容 API 和模型。 |
...
| 硅基流动中国站 / 国际站 | `Qwen/Qwen3.6-27B` | OpenAI Chat | 支持；两个站点的账户、Key 与 API 地址需对应 |
